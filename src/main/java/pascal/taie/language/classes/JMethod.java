...
public class JMethod extends ClassMember {
    ...
    /**
     * Overrides {@link ClassMember#setDeclaringClass} to also refresh the
     * {@code signature} string, which is baked at construction time.
     * This is necessary when a synthetic method is created with a {@code null}
     * declaring class (e.g. by {@code CodeEnhancer}) and the class is assigned
     * later via {@code EnhancedClass.build()}.
     */
    @Override
    public void setDeclaringClass(JClass declaringClass) {
    ...
    /**
     * Allows setting the IR for this method (for dynamic enhancement).
     */
