...
public abstract class AbstractCallGraph<CallSite, Method>
    ...
    /**
     * Set of all reachable methods, including methods that cannot provide IR.
     */
    protected Set<Method> allReachableMethods = Sets.newSet();

    /**
     * Set of reachable methods that can provide IR. This field is not final so that
     * it allows subclasses choose more efficient data structure.
     */
    protected Set<Method> reachableMethods = Sets.newSet();

    protected boolean addReachableMethod(Method method, boolean canProvideIR) {
        allReachableMethods.add(method);
        return canProvideIR && reachableMethods.add(method);
    }
    ...
    @Override
    public Stream<Method> allReachableMethods() {
        return allReachableMethods.stream();
    }

    @Override
    public int getNumberOfMethods() {
        return allReachableMethods.size();
    }

    @Override
    public boolean contains(Method method) {
        return allReachableMethods.contains(method);
    }
    ...
    public Set<Method> getNodes() {
        return Collections.unmodifiableSet(allReachableMethods);
    }
}
