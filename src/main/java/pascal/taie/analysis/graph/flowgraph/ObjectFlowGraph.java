...
public class ObjectFlowGraph extends NodeManager
     ...
     */
    public Node toNode(Pointer pointer) {
        ...
        } else if (pointer instanceof ConPointer conPointer) {
            return getOrCreateConPointerNode(
                    conPointer.getContainerObj().getObject(),
                    conPointer.getAccessPattern());
        } else if (pointer instanceof BeanPointer beanPointer) {
            return getOrCreateBeanPointerNode(beanPointer);
        } else {
