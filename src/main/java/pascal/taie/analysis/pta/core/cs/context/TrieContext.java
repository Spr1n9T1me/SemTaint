...
public class TrieContext implements Context {
    ...
    private final Object originElement;
    ...
    private TrieContext(TrieContext parent, Object elem) {
        ...
        this.originElement = (parent.length == 0) ? elem : parent.originElement;
    }
    ...
    public TrieContext getParent() {
        return parent;
    }

    public TrieContext getChild(Object elem) {
        if (children == null) {
